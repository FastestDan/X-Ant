...
#ifndef XANT_GAMEOBJECTS_PLAYER_H_
#define XANT_GAMEOBJECTS_PLAYER_H_
...
public:
	enum class Race
	{
		...
		Craussie = 2,	// -Health-Attack-Armor
		Bot = 3,	// +Health+Attack+Armor
		AntWarrior = 4	// -Health+Attack+Armor
	};
...
#endif // XANT_GAMEOBJECTS_PLAYER_H_